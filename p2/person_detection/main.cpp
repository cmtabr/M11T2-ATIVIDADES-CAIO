...
// #define BLUETOOTH "ESP32BT"
  ...
  DumbDisplay dumbdisplay(new DDBluetoothSerialIO("ESP-teste"));
#elseledSetup not defined tensorflowlite espcam
  #include "wifidumbdisplay.h"
  DumbDisplay dumbdisplay(new DDWiFiServerIO("SHARE-RESIDENTE", "Share@residente23"));
#endif
